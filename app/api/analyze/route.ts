...
// ================================================================
function getLegalOpinion(ct: string, owner: string, applicant: string, _unused: string, existingBank: string): string {
...
STEP B: ROLE FLIP RULE -- CRITICAL:
  ...
  When Bank appears in Col3 -> RELEASE EVENT -> matching CHARGE = RELEASED
...
For each document:
<div class="di"><p><span class="dn">N. [Document Type] -- Reg. No. [X] | Dated: [DD-MM-YYYY]</span><br>[Executant/s individually] unto and in favour of [Claimant/s individually] registered at Sub-Registrar Office, [SRO].</p></div>
For EC:
<div class="di"><p><span class="dn">N. Encumbrance Certificate -- E-App. No.: [no] | Dated: [date] | Search Period: [from] to [to]</span><br>EC bearing E-Application No. [no] dated [date] for period [from] to [to] issued by IGR, Revenue Department, Government of Gujarat. [N] transaction/s found on row-by-row examination.</p></div>
...
<ol>[case-specific list based on case type]</ol>
...
RELEASED mortgage: "stands discharged and charge fully released and satisfied"
ACTIVE mortgage: "subsisting and active as on date"
