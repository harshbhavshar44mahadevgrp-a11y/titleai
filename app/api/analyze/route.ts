...
const REV_PS = 'LANGUAGE: Output everything in English only. No Gujarati script in any field of your JSON output.\nTranslate all Gujarati terms: \'Bin Kheti\'=\'Non-Agricultural\' | \'Juni Sharat\'=\'Old Tenure\' | \'Naa Sharat\'=\'New Tenure\'\nTranslate Gujarati status terms: \'પ્રમાણિત\'=\'Certified\' | \'કબજાની પ્રમાણિત\'=\'Certified\' | \'માન્ય\'=\'Approved\' | \'ચકાસ\'=\'Under Revision\' | \'રદ\'=\'Rejected\' | \'બાકી\'=\'Pending\' | \'નામ દાખ\'=\'Name Entry\' | Any Gujarati word meaning certified/approved = \'Certified\'\n\nLook at ALL uploaded images. Find Revenue Records of any type: Village Form No. 6, 7/12, 8-A, Property Card, Hakk Patrak, Mutation Register, FERFAR, Gamnamuma No. 6.\n\nMUTATION ENTRY BLOCK STRUCTURE — HOW TO READ EACH ENTRY:\nIn Gujarat Revenue Records, each Mutation Entry (Nondh) block typically appears as:\n  Line 1: Entry Number (a plain number e.g. 3795)\n  Line 2: Entry Date (format DD/MM/YYYY or DD-MM-YYYY e.g. 08/02/2006)\n  Line 3: Status in Gujarati (e.g. \'કબજાની પ્રમાણિત\' = Certified)\n  Following lines: Narrative content in Gujarati describing the nature of mutation, parties, survey numbers, reason, and supporting document\nCRITICAL: The date and status ARE present in the document — search WITHIN each entry block carefully.\nDo NOT output \'not stated\' unless you have searched the complete entry block and found nothing.\n\nEXTRACT FOR SUBJECT PROPERTY ONLY:\n- village, taluka, district (English transliteration)\n- survey_block_no (include old AND new survey numbers if both visible)\n- total_area (with unit)\n- land_use (English: Non-Agricultural / Agricultural)\n- tenure (English: Old Tenure / New Tenure — if mentioned)\n- ownership_column (current Kabjedar name in English)\n- boja_column (ALL Boja entry numbers and any descriptions visible)\n- ganot_column (NIL if blank)\n\nMUTATION ENTRIES — EXTRACT EVERY SINGLE ONE, OLDEST TO NEWEST:\nFor EVERY visible Nondh/Mutation/FERFAR entry extract ALL of the following fields:\n  e = Mutation Entry Number (the number at the top of each entry block)\n  d = Entry Date (DD/MM/YYYY — look at the second line of each entry block)\n  cd = Certification Date (if separately stated; otherwise same as d)\n  s = Status (translate from Gujarati — e.g. \'Certified\', \'Pending\', \'Rejected\', \'Under Revision\')\n  po = Previous Owner full name (who is transferring — translate from Gujarati narrative)\n  no = New Owner full name (who is receiving — translate from Gujarati narrative)\n  n = Nature of entry (Sale / Inheritance / Partition / Gift / NA Conversion / Mortgage / Release / Court Order / Correction / Name Entry / etc — translate from Gujarati)\n  r = Reason of mutation (brief sentence explaining WHY this mutation happened — translate from Gujarati narrative)\n  sv = Survey Number(s) mentioned in this entry\n  sd = Supporting document type and number if mentioned (e.g. \'Sale Deed No. 1234 dated DD-MM-YYYY\')\n  rm = Any legally relevant remarks in this entry (translate from Gujarati)\n\nDO NOT stop early. Extract ALL entries. If document has 30 entries, extract all 30.\nIf date is in Gujarati numerals (૧,૨,૩... = 1,2,3...), convert to Arabic numerals.\nIf Gujarati numerals appear: ૦=0 ૧=1 ૨=2 ૩=3 ૪=4 ૫=5 ૬=6 ૭=7 ૮=8 ૯=9\n\nOutput ONLY this JSON (no other text before or after):\n{"document_type_found":"snapshot OR ledger","village":"","taluka":"","district":"","survey_block_no":"","total_area":"","land_use":"","tenure":"","ownership_column":"","boja_column":"","ganot_column":"","entries":[{"e":"entry_no","d":"entry_date_DD/MM/YYYY","cd":"certification_date","s":"Certified_or_Pending_etc","po":"previous_owner_in_English","no":"new_owner_in_English","n":"nature_in_English","r":"reason_in_English","sv":"survey_no","sd":"supporting_doc","rm":"remarks_in_English"}]}\nIf no revenue record document is found anywhere: {"found":false}'
