...
const REV_PS = 'LANGUAGE: Output ONLY English in all JSON fields. No Gujarati script anywhere in the output.\nTranslate Gujarati terms: \'Bin Kheti\'=Non-Agricultural | \'Juni Sharat\'=Old Tenure | \'Naa Sharat\'=New Tenure\nTranslate Gujarati status words: \'પ્રમાણિત\'=Certified | \'કબજાની પ્રમાણિત\'=Certified | \'ચકાસ\'=Under Revision | \'રદ\'=Rejected | \'બાકી\'=Pending\nGujarati digits: ૦=0 ૧=1 ૨=2 ૩=3 ૪=4 ૫=5 ૬=6 ૭=7 ૮=8 ૯=9 — convert all Gujarati digits to Arabic.\n\nLook at ALL uploaded images. Find Revenue Records of any type:\nVillage Form No. 6, 7/12 (Satbara), 8-A, Property Card, Hakk Patrak, Mutation Register, FERFAR Register, Gamnamuma No. 6.\n\nDOCUMENT TYPE: Is this a snapshot (shows current state only) or a ledger (lists historical entries)? Report in document_type_found.\n\nEXTRACT FOR SUBJECT PROPERTY:\nvillage (English) | taluka (English) | district (English) | survey_block_no (old AND new if both visible) | total_area | land_use (English) | tenure (English) | ownership_column (English) | boja_column (ALL entry numbers and descriptions) | ganot_column\n\n═══════════════════════════════════════\nMUTATION ENTRY EXTRACTION — MOST CRITICAL\n═══════════════════════════════════════\n\nREAD EVERY PAGE OF THE DOCUMENT. Do not stop at page 1.\nEXTRACT EVERY SINGLE MUTATION ENTRY visible anywhere in the document — oldest to newest.\nIf the document has 5 entries, extract all 5. If it has 30, extract all 30. If it has 50, extract all 50.\nDO NOT STOP EARLY. DO NOT SKIP ANY ENTRY. Continue reading until the last page of the document.\n\nHOW TO READ EACH MUTATION ENTRY BLOCK in Gujarat Revenue Records:\nEach entry block typically has this structure:\n  First element: Entry Number (a plain integer, e.g. 3795)\n  Second element: Entry Date (DD/MM/YYYY — convert Gujarati digits if needed)\n  Third element: Status word in Gujarati (e.g. \'પ્રમાણિત\' = Certified) — translate to English\n  Remaining content: Mutation narrative in Gujarati describing parties, survey numbers, nature, supporting document\nNEVER output \'not stated\' for date or status — search the complete entry block first.\nThe date and status are always present in a certified entry — they appear in the block header.\n\nFor each entry extract these COMPACT fields (use short names to fit more entries in output):\n  e  = Mutation Entry Number\n  d  = Entry Date in DD/MM/YYYY (convert Gujarati digits to Arabic)\n  cd = Certification Date (if different from d; else same as d)\n  s  = Status in English (Certified / Pending / Rejected / Under Revision)\n  po = Previous Owner full name in English (who is giving up / transferring)\n  no = New Owner full name in English (who is receiving)\n  n  = Nature in English (Sale / Inheritance / Partition / Gift / NA Conversion / Mortgage / Release / Court Order / Correction / Name Entry)\n  r  = Short reason in English (e.g. \'Sale Deed executed between parties\' or \'Devolution on death\')\n  sv = Survey Number(s) mentioned in this entry\n  sd = Supporting document type and number if mentioned (e.g. \'Sale Deed No.1234 dated DD/MM/YYYY\')\n  rm = Any legally relevant remarks (short, in English)\n\nOUTPUT FORMAT — STRICTLY FOLLOW:\nOutput ONLY the JSON object below. No text before it. No text after it.\nKeep all field VALUES as short as possible to fit more entries.\n{"document_type_found":"","village":"","taluka":"","district":"","survey_block_no":"","total_area":"","land_use":"","tenure":"","ownership_column":"","boja_column":"","ganot_column":"","entries":[{"e":"","d":"","cd":"","s":"","po":"","no":"","n":"","r":"","sv":"","sd":"","rm":""}]}\nIf no revenue record found anywhere: {"found":false}'
