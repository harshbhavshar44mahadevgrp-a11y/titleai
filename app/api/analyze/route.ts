...
const REV_PS = 'LANGUAGE: Output ONLY English in all JSON fields. No Gujarati script anywhere in output.\nTranslate: Bin Kheti=Non-Agricultural | Juni Sharat=Old Tenure | Naa Sharat=New Tenure\nTranslate status: પ્રમાણિત=Certified | કબજાની પ્રમાણિત=Certified | ચકાસ=Under Revision | રદ=Rejected | બાકી=Pending\nGujarati digits: ૦=0 ૧=1 ૨=2 ૩=3 ૪=4 ૫=5 ૬=6 ૭=7 ૮=8 ૯=9\n\nLook at ALL uploaded images. Find Revenue Records: Village Form No. 6, 7/12 (Satbara), 8-A, Property Card, Hakk Patrak, Mutation Register, FERFAR Register, Gamnamuma No. 6.\n\n════════════════════════════════════════\nVILLAGE FORM NO. 7 (SATBARA / 7-12) — WHAT TO EXTRACT:\n════════════════════════════════════════\nFrom Village Form No. 7 extract:\n- Village name (Mouje), Taluka, District\n- Survey Number / Block Number / Final Plot Number (old AND new if both visible)\n- Total Area (H.Are.SqMt. or Sq.Mtrs.)\n- Land Use (Jaminno Upyog) — exact term in English (Non-Agricultural / Agricultural)\n- Current Kabjedar/Khatedar name (Ownership column)\n- Boja/Encumbrance column — ALL entry numbers visible\n- Ganot/Tenant column\n- Any NA Order reference or Land Use conversion noted\n\n════════════════════════════════════════\nFERFAR / MUTATION REGISTER / GAMNAMUMA NO. 6 — EXACT COLUMN STRUCTURE:\n════════════════════════════════════════\nThe FERFAR register has the following column structure (read left to right):\n\nCOLUMN 1 (Leftmost column): Contains Mutation Entry Number (Nondh Number) + Date of Mutation Entry + Status (Certified / Rejected / Pending)\n→ ALWAYS extract: Mutation Entry Number, Date, and Status from Column 1\n→ NOTE: Do NOT include the very first sub-column of Entry Details section (administrative numbering) — focus on the actual Mutation Number, Date, and Status\n\nCOLUMN 2 (Second from left): Contains the FULL DETAILS of the mutation entry\n→ This is the most important column\n→ Describes WHAT happened: Sale, Transfer, Death of owner, Inheritance, NA Conversion, Partition, Gift, Court Order, Mortgage, Release of Mortgage, etc.\n→ Contains names of previous owner (who transferred) and new owner (who received)\n→ Contains nature/reason of mutation\n→ May reference a supporting document (Sale Deed, Will, Court Order, etc.)\n→ ALWAYS extract ALL details from Column 2 and reconstruct the full mutation narrative\n\nCOLUMN 3 (Third from left): Contains Survey Number / Block Number relevant to this mutation\n→ Extract ONLY if the Survey/Block Number is relevant to the SUBJECT PROPERTY\n→ If not relevant to subject property, skip this column\n\nCOLUMN 4 (Last/Fourth column from left): May contain additional notes or remarks\n→ Extract any legally relevant remarks from Column 4\n\n════════════════════════════════════════\nEXTRACTION RULES — MANDATORY:\n════════════════════════════════════════\n1. Read ALL pages of the FERFAR document from beginning to end\n2. Extract EVERY SINGLE mutation entry — do not stop after first few\n3. Arrange all entries oldest to newest (chronological order)\n4. Cover all available years — if 30 years available, extract all 30\n5. NEVER output not stated for Date or Status unless genuinely absent after full search\n6. The Date and Status are ALWAYS in Column 1 of each entry block\n7. If Gujarati digits appear in dates, convert to Arabic numerals\n\nFor each mutation entry extract these compact fields:\n  e  = Mutation Entry Number (from Column 1)\n  d  = Entry Date DD/MM/YYYY (from Column 1 — convert Gujarati digits)\n  cd = Certification Date if different from d (else same as d)\n  s  = Status: Certified / Pending / Rejected / Under Revision (from Column 1)\n  po = Previous Owner full name in English (from Column 2)\n  no = New Owner full name in English (from Column 2)\n  n  = Nature of mutation in English: Sale / Inheritance / Death / Partition / Gift / NA Conversion / Mortgage / Release / Court Order / Correction (from Column 2)\n  r  = Full reason/details reconstructed from Column 2 (supporting deed number/date if mentioned)\n  sv = Survey Number from Column 3 (only if relevant to subject property)\n  sd = Supporting document type and number if mentioned in Column 2\n  rm = Any remarks from Column 4\n\nOUTPUT — STRICTLY JSON ONLY, NO OTHER TEXT:\n{"document_type_found":"","village":"","taluka":"","district":"","survey_block_no":"","total_area":"","land_use":"","tenure":"","ownership_column":"","boja_column":"","ganot_column":"","entries":[{"e":"","d":"","cd":"","s":"","po":"","no":"","n":"","r":"","sv":"","sd":"","rm":""}]}\nIf no revenue record found: {"found":false}'
