...
================================================
!!!!!! CRITICAL: HOW  (GIRO) WORKS IN EC !!!!!!
MUST READ BEFORE PROCESSING ANY EC ENTRY
================================================

"" alone OR " " OR ".." = MORTGAGE DEED
 In mortgage: Col 3 (Aapnar) = OWNER, Col 4 (Lenar) = BANK

"" + "" OR "" + "" modifier = RELEASE OF MORTGAGE (NOT a mortgage!)
 " ..." = "Mortgage RELEASED" -- the mortgage is OVER
 " " = RELEASED mortgage = RECONVEYANCE DEED
 " .." anything = Release, Release, Release -- NEVER a Mortgage
...
If Col 1 contains: " " OR ".." OR "Giro Mukeli" OR "Giro Mukti" OR "Mukeli" OR "Mukti"
OR "Release" OR "Reconveyance" OR "Discharge" OR "Satisfaction" OR "Released" OR ""
...
If Col 1 TEXT = "" alone AND Col 4 = Bank  Mortgage Deed

[WARNING] BAJAJ HOUSING FINANCE LIMITED = a financial institution = BANK for this purpose
[WARNING] Any "HOUSING FINANCE" company = bank for release detection purposes
[WARNING] When BAJAJ HFL (or any bank) is in Col 3  they are RELEASING the mortgage  RELEASE DEED
...
COL 7 (Seventh/LAST): [NEVER] NEVER READ. NEVER EXTRACT. NEVER MENTION. PERMANENT RULE.
...
[WARNING] EC HEADER COUNT IS UNRELIABLE: "X registered transactions" in header = often WRONG.
...
* Treat transliteration variants as same: "Banakhat"="Bana Khat"=""
...
================================================
[WARNING] RELEASE DEED DETECTION -- READ THIS CAREFULLY [WARNING]
================================================
...
"      "
" " / ".." / "Giro Mukti" / "Giro Mukeli"
" " / "Mortgage Release" / "Release of Mortgage"
...
MOST IMPORTANT DISAMBIGUATION:
  "" ALONE = Mortgage Deed
  "" + "" TOGETHER = Reconveyance Deed (NOT Mortgage!)
================================================
Mortgage Deed                  / .. /  (ALONE -- no "" after it) / Giro / Boja / Mortgage
   ONLY when Col 4 (Lenar) = Bank, AND Col 1 text does NOT contain ""

Reconveyance Deed             ... / .. /  ... / Giro Mukeli / Giro Mukti / Release of Mortgage / Mortgage Release / Reconveyance / Discharge of Mortgage / Satisfaction
   ANY "" + "" combination = Release. ".." = Release. Bank in Col 3 = Release.

Mortgage Release Deed          / .. / Giro Mukti /   
Release Deed                   / Release Deed (generic)

Sale Deed                      /  / .. / Maliki Ferkhat / Sale / Conveyance
Absolute Sale Deed            
Gift Deed                      /   / 
Relinquishment Deed            
Partition Deed                / .. /  
...
Exchange Deed                 
Simple Mortgage Deed           (only if text explicitly says "Simple"/"Sado")
Equitable Mortgage             (only if text says "Equitable")
Lease Deed                     / ..
Leave and License Agreement    
Rent Agreement                
Development Agreement          / JDA
Joint Development Agreement    
Agreement to Sell              / Banakhat (with possession)
Agreement to Sell (No Poss)      NEVER = Sale Deed
Power of Attorney             / POA (generic)
General Power of Attorney     . / GPA
Special Power of Attorney     . / SPA
POA under Section 45-A       45- / 45-A
Revocation of POA            . 
Will                          /  
Probate                       
Succession Certificate        
Legal Heir Certificate       
Declaration Deed              / Declaration
Rectification Deed           
Cancellation Deed             / Cancellation
...
[WARNING] Read ALL EC_ROW_[N] and MORTGAGE_[N]_ANALYSIS from Layer 1.
[WARNING] MORTGAGE_STATUS=DISCHARGED = DO NOT flag as alert. Charge is satisfied.
[WARNING] MORTGAGE_STATUS=ACTIVE = Flag as active encumbrance in alerts.
[WARNING] UNIDENTIFIED EC type = Flag for manual review (Medium Severity).
...
IF DISCHARGED (Release Deed found -- either in EC as " ..." entry OR as submitted document):
...
[WARNING] DO NOT say "No discharge found" for any mortgage that Layer 1 marked as DISCHARGED.
[WARNING] A " ..." entry in EC = the mortgage IS discharged. Do not say otherwise.
FINAL PARA:
...
2. [WARNING] MULTIPLE ECs -- PROCESS ALL:
...
7. !! RELEASE (TEXT): "Giro Muk" / "" + "" / "Giro " = Release of Mortgage
...
[WARNING] IF MORTGAGE_STATUS=DISCHARGED in Layer 1  DO NOT flag as active encumbrance.
[WARNING] IF MORTGAGE_STATUS=ACTIVE  flag in alerts as active mortgage.` }]
    })
...
Part V EC table: every actual row, show Classified Type + Match Confidence. NEVER Col 7. NEVER EC Applicant. DISCHARGED = class ec-dis. ACTIVE = class ec-act. UNIDENTIFIED = class ec-unk.` }]
      ...
      client.messages.create({
        model: 'claude-sonnet-4-6', max_tokens: 6000, temperature: 0, system: L4C, messages: [{
          role: 'user', content:
            `Parts VI+VII+VIII.
...
ANALYSIS: ${analysis}
RULES: Part VI = max 5-6 alerts only (HIGH first, then MEDIUM, then LOW). Be CONCISE - 2-3 sentences per alert max. NEVER flag EC-confirmed deeds. NEVER flag EC Applicant. NEVER flag DISCHARGED mortgage. Flag UNIDENTIFIED EC entries as Medium.
Part VII = concise lists only.
Part VIII = EXACT legal opinion wording with actual names.` }]
      }),
