    ...
    <div style={{ background: '#04040f', fontFamily: 'Inter, system-ui, sans-serif', overflowX: 'hidden', color: '#e2e8f0' }}>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 56px', background: 'rgba(4,4,15,0.85)', backdropFilter: 'blur(28px)', borderBottom: '1px solid rgba(99,102,241,0.08)' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <button onClick={() => router.push('/upload')} style={{ padding: '7px 20px', borderRadius: '7px', border: '1px solid rgba(99,102,241,0.15)', background: 'transparent', color: '#64748b', fontSize: '13px', cursor: 'pointer', transition: 'all 0.2s' }} onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(99,102,241,0.4)'; e.currentTarget.style.color = '#94a3b8' }} onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(99,102,241,0.15)'; e.currentTarget.style.color = '#64748b' }}>Sign In</button>
